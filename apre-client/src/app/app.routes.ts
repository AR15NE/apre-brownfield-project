...
import { SalesByProductTabularComponent } from './reports/sales/sales-by-product-tabular/sales-by-product-tabular.component';
...
export const salesReportRoutes: Routes = [
  ...
  {
    path: 'sales-by-product-tabular',
    component: SalesByProductTabularComponent
  }
];
